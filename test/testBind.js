...
var viteToken = viteTokenContract.at('0xaa646e70fda92c82d835c5f4e3bfe5d0a084feda');
...
contract('Erc2Vite full test', async (accounts) => {
  ...
  it('call bind method', async () => {
      ...
      const viteAddr = "vite_098dfae02679a4ca05a4c8bf5dd00a8757f0c622bfccce7d62";
      await erc2vite.bind(viteAddr,323545, {from:sender, gas: 500000});
